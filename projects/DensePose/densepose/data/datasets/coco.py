...
DATASETS = [
    CocoDatasetInfo(
        ...
        images_root="balloon/train2014",
        annotations_fpath="balloon/annotations/densepose_train2014.json",
    ),
    CocoDatasetInfo(
        name="densepose_coco_2014_minival",
        images_root="balloon/val2014",
        annotations_fpath="balloon/annotations/densepose_minival2014.json",
    ),
    CocoDatasetInfo(
        name="densepose_coco_2014_minival_100",
        images_root="balloon/val2014",
        annotations_fpath="balloon/annotations/densepose_minival2014_100.json",
    ),
    CocoDatasetInfo(
        name="densepose_coco_2014_valminusminival",
        images_root="balloon/val2014",
        annotations_fpath="balloon/annotations/densepose_valminusminival2014.json",
    ),
    CocoDatasetInfo(
    ...
    CocoDatasetInfo(
        name="lvis_v05_train",
        images_root="balloon/train2017",
        annotations_fpath="lvis/lvis_v0.5_plus_dp_train.json",
    ),
    CocoDatasetInfo(
        name="lvis_v05_val",
        images_root="balloon/val2017",
...
BASE_DATASETS = [
    CocoDatasetInfo(
        ...
        images_root="balloon/train2017",
        annotations_fpath="balloon/annotations/instances_train2017.json",
    ),
    CocoDatasetInfo(
        name="base_coco_2017_val",
        images_root="balloon/val2017",
        annotations_fpath="balloon/annotations/instances_val2017.json",
    ),
    CocoDatasetInfo(
        name="base_coco_2017_val_100",
        images_root="balloon/val2017",
        annotations_fpath="balloon/annotations/instances_val2017_100.json",
    ),
]
...
def _load_coco_annotations(json_file: str):
    ...
    Returns:
        Instance of `pycocotools.balloon.COCO` that provides access to annotations
        data
    """
...
def load_coco_json(annotations_json_file: str, image_root: str, dataset_name: str):
    ...
    Replaces `detectron2.data.datasets.balloon.load_coco_json` to handle metadata
