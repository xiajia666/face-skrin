...
if __name__ == "__main__":
    ...
    # python labelme2coco.py test --output train.json(coco file)
...
# cd C:\Users\34261\Desktop\detectron2\xj_train\
#     python labelme2coco.py  ./json/imgs/annotations/ --output train.json