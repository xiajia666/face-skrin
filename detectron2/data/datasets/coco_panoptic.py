...
def load_coco_panoptic_json(json_file, image_dir, gt_dir, meta):
    """
    Args:
        image_dir (str): path to the raw dataset. e.g., "~/balloon/train2017".
        gt_dir (str): path to the raw annotations. e.g., "~/balloon/panoptic_train2017".
        json_file (str): path to the json file. e.g., "~/balloon/annotations/panoptic_train2017.json".
